<template>
  <div class="graph-clipart" v-if="!isTablet">
    <svg
      width="542"
      height="1024"
      viewBox="0 0 542 1024"
      fill="none"
        ...
        <g id="graph">
          <g id="Vector">
            ...
            <path
              ...
              stroke="#6B09C0"
              stroke-opacity="0.5"
              stroke-width="1.29674"
              stroke-miterlimit="10"
            />
          </g>
          <path
            id="Vector_2"
            d="M107.428 543.763C111.509 543.763 114.817 540.449 114.817 536.36C114.817 532.271 111.509 528.956 107.428 528.956C103.347 528.956 100.039 532.271 100.039 536.36C100.039 540.449 103.347 543.763 107.428 543.763Z"
            fill="#6B09C0"
          />
          <path
            id="Vector_3"
            d="M7.38923 569.22C11.4702 569.22 14.7785 565.905 14.7785 561.816C14.7785 557.727 11.4702 554.413 7.38923 554.413C3.30827 554.413 0 557.727 0 561.816C0 565.905 3.30827 569.22 7.38923 569.22Z"
            fill="#6B09C0"
          />
          <path
            id="Vector_4"
            d="M205.762 472.007C209.843 472.007 213.151 468.692 213.151 464.604C213.151 460.515 209.843 457.2 205.762 457.2C201.681 457.2 198.372 460.515 198.372 464.604C198.372 468.692 201.681 472.007 205.762 472.007Z"
            fill="#6B09C0"
          />
          <path
            id="Vector_5"
            d="M160.289 398.599C164.37 398.599 167.679 395.284 167.679 391.196C167.679 387.107 164.37 383.792 160.289 383.792C156.208 383.792 152.9 387.107 152.9 391.196C152.9 395.284 156.208 398.599 160.289 398.599Z"
            fill="#6B09C0"
          />
          <path
            id="Vector_6"
            d="M254.758 346.604C258.839 346.604 262.147 343.289 262.147 339.201C262.147 335.112 258.839 331.797 254.758 331.797C250.677 331.797 247.369 335.112 247.369 339.201C247.369 343.289 250.677 346.604 254.758 346.604Z"
            fill="#6B09C0"
          />
          <path
            id="Vector_7"
            d="M359.799 414.488C363.88 414.488 367.188 411.173 367.188 407.085C367.188 402.996 363.88 399.681 359.799 399.681C355.718 399.681 352.41 402.996 352.41 407.085C352.41 411.173 355.718 414.488 359.799 414.488Z"
            fill="#6B09C0"
          />
          <path
            id="Vector_8"
            d="M410.273 473.26C414.354 473.26 417.662 469.945 417.662 465.856C417.662 461.768 414.354 458.453 410.273 458.453C406.192 458.453 402.884 461.768 402.884 465.856C402.884 469.945 406.192 473.26 410.273 473.26Z"
            fill="#6B09C0"
          />
          <path
            id="Vector_9"
            d="M457.678 345.807C461.758 345.807 465.067 342.492 465.067 338.403C465.067 334.315 461.758 331 457.678 331C453.597 331 450.288 334.315 450.288 338.403C450.288 342.492 453.597 345.807 457.678 345.807Z"
            fill="#6B09C0"
          />
          <path
            id="Vector_10"
            d="M534.254 570C538.334 570 541.643 566.685 541.643 562.597C541.643 558.508 538.334 555.193 534.254 555.193C530.173 555.193 526.864 558.508 526.864 562.597C526.864 566.685 530.173 570 534.254 570Z"
            fill="#6B09C0"
          />
          <path
            id="Vector_11"
            d="M308.074 544.333C312.155 544.333 315.463 541.018 315.463 536.929C315.463 532.841 312.155 529.526 308.074 529.526C303.993 529.526 300.685 532.841 300.685 536.929C300.685 541.018 303.993 544.333 308.074 544.333Z"
            fill="#6B09C0"
          />
        </g>
      </g>
...
export default class ProductSummaryClipart extends Vue {
  ...
  /** Returns true if user device is a tablet */
  ...
  mounted() {
    ...
    const scrollTriggerConfig = {
      ...
      start: this.isPhone ? "center center" : "bottom center",
      end: this.isPhone ? "top top" : "+=550px",
      scrub: this.isPhone ? false : true,
      endTrigger: this.isPhone ? "#setting-up" : undefined,
    ...
    timeline
      .to(".graph-clipart", {
        scale: this.isPhone ? 1.2 : 1
      })
      .from("#graph", {
        y: -150
      })
      .to("#graph", {
        scale: this.isPhone ? 1 : 0.6,
        transformOrigin: "50% 50%"
      })
      .from(
        "#screenshot",
        {
          scale: this.isPhone ? 1.5 : 1.2,
          opacity: 0,
          transformOrigin: "50% 50%"
        },
        "-=1"
