<template>
  <div class="tos-container">
    ...
    <p>
      ...
      of Trackgit's Website, located at trackgit.com and all other sub-domains.
    </p>

    <p>
      By accessing this website we assume you accept these terms and conditions.
      Do not continue to use Trackgit if you do not agree to take all of the
    ...
    <p>
      We employ the use of cookies. By accessing Trackgit, you agreed to use
      cookies in agreement with the Trackgit's Privacy Policy.
    </p>
    ...
    <p>
      Unless otherwise stated, Trackgit and/or its licensors own the
      intellectual property rights for all material on Trackgit. All
      intellectual property rights are reserved. You may access this from
      Trackgit for your own personal use subjected to restrictions set in these
      terms and conditions.
    </p>

    <p>You must not:</p>
    <ul>
      <li>Republish material from Trackgit</li>
      <li>Sell, rent or sub-license material from Trackgit</li>
      <li>Reproduce, duplicate or copy material from Trackgit</li>
      <li>Redistribute content from Trackgit</li>
    </ul>
    ...
    <p>
      ...
      information in certain areas of the website. Trackgit does not filter,
      edit, publish or review the information prior to their presence on the
      website. Content posted by users do not reflect the views and opinions of
      Trackgit, its agents and/or affiliates. User-generated contents reflect
      the views and opinions of the person who post their views and opinions. To
      the extent permitted by applicable laws, Trackgit shall not be liable for
      the user-generated content or for any liability, damages or expenses
      caused and/or suffered as a result of any use of and/or posting of and/or
      appearance of the content on this website.
    </p>

    <p>
      Trackgit reserves the right to monitor all user-generated content and to
      remove any user-generated content which can be considered inappropriate,
    ...
    <ul>
      <li>
        You are entitled to post content on our website and have all necessary
        licenses and consents to do so;
      </li>
      <li>
        The user-generated contents do not invade any intellectual property
        right, including without limitation copyright, patent or trademark of
        any third party;
      </li>
      <li>
        The user-generated contents do not contain any defamatory, libelous,
        offensive, indecent or otherwise unlawful material which is an invasion
        of privacy
      </li>
      <li>
        The user-generated contents will not be used to solicit or promote
    ...
    <p>
      You hereby grant Trackgit a non-exclusive license to use, reproduce, edit
      and authorize others to use, reproduce and edit any of your generated
      content in any and all forms, formats or media.
    </p>
    ...
    <p>
      ...
      hyperlink compensates the absence of Trackgit; and (d) the link is in the
    ...
    <p>
      ...
      e-mail to Trackgit. Please include your name, your organization name,
    ...
    <p>
      No use of Trackgit's logo or other artwork will be allowed for linking
